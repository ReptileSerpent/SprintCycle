...
func _on_VacationOfferButton_pressed():
	$"/root/Main/PopupPanel".visible = true

func _on_CourseEnrollmentButton_pressed():
	$"../..".visible = false
	$"/root/Main/ColorRect/VBoxContainer2/CourseEnrollmentGUI".visible = true
...
func _on_AssignmentButton_toggled(button_pressed):
	...
	if (button_pressed):
		...
		$"/root/Main/ColorRect/VBoxContainer2/DevelopersGUI".current_task_being_assigned.assigned.append(developer_class_instance)
		$"/root/Main/ColorRect/VBoxContainer2/DevelopersGUI".current_task_being_assigned.assigned_temporarily.erase(developer_class_instance)
	else:
		$"/root/Main/ColorRect/VBoxContainer2/DevelopersGUI".current_task_being_assigned.assigned.erase(developer_class_instance)

func _on_TemporaryAssignmentButton_toggled(button_pressed):
	if (button_pressed):
		$"AssignmentButton".pressed = false
		$"/root/Main/ColorRect/VBoxContainer2/DevelopersGUI".current_task_being_assigned.assigned_temporarily.append(developer_class_instance)
		$"/root/Main/ColorRect/VBoxContainer2/DevelopersGUI".current_task_being_assigned.assigned.erase(developer_class_instance)
	else:
		$"/root/Main/ColorRect/VBoxContainer2/DevelopersGUI".current_task_being_assigned.assigned_temporarily.erase(developer_class_instance)
